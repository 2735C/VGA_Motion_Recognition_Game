...
현대 사회는 지속적으로 우울증 환자가 증가하고 있습니다. 
건강보험공단에서 제출받은 자료에 따르면, 2020년 약 87만 명이었던 우울증 환자 수가 2023년에는 약 109만 명으로 25% 증가했으며, 특히 아동 및 청소년, 청년층에서 급증하는 추세를 보였습니다.

<img src="/History/img/another/img_7.png" width=400 >|
--|

연구 결과에 따르면 능동적인 활동은 우울감이 감소시키고 스트레스 해소에 도움이 된다고 합니다.
...
실제 춤 동작을 추면서 학습 및 게임 경험 제공

실시간 피드백: 사용자의 모션과 화면 동작 매칭
